...
public class FahrenheitCelsiusTest extends junit.framework.TestCase {
	...
	public void test_fahrenheitEnCelsius() {
		...
		assertEquals("   2323°F -> 1272.7°C ?", 1272.7, question1.FahrenheitCelsius.fahrenheitEnCelsius(2323), 0.1);
		assertEquals("   23333°F -> 12945.0°C ?", 12945.0, question1.FahrenheitCelsius.fahrenheitEnCelsius(23333), 0.1);
		assertEquals("   2°F -> -16.6°C", -16.6, question1.FahrenheitCelsius.fahrenheitEnCelsius(2), 0.1);assertEquals("   2323°F -> 1272.7°C ?", 1272.7, question1.FahrenheitCelsius.fahrenheitEnCelsius(2323), 0.1);
		assertEquals("   23333°F -> 12945.0°C ?", 12945.0, question1.FahrenheitCelsius.fahrenheitEnCelsius(23333), 0.1);
